...
const DEFAULTS: NotificationPreferences = { daily:false,friday:false,campaigns:false,emergency:false,quran:false,hadith:false,dua:false,dhikr:false,shirk:false,sadaqah:false,motivation:false,impact:false,humanitarian:false,onboarding_seen:true };
...
export default function NotificationPreferencesScreen() {
  ...
  return <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
    ...
    <PreferenceSection title="Faith & reminders"><PreferenceRow icon="book-outline" title="Quran Reminders" description="Approved Quran reminder content from Family Pledge." value={preferences.quran} onChange={v=>setValue('quran',v)}/><PreferenceRow icon="library-outline" title="Hadith Reminders" description="Approved hadith reminders and source-referenced messages." value={preferences.hadith} onChange={v=>setValue('hadith',v)}/><PreferenceRow icon="heart-outline" title="Du'a Reminders" description="Du'as and prayer reminders shared through Family Pledge." value={preferences.dua} onChange={v=>setValue('dua',v)}/><PreferenceRow icon="repeat-outline" title="Dhikr / Adhkar Reminders" description="Source-reviewed morning, evening, anytime, protection, after-prayer and before-sleep adhkar." value={preferences.dhikr} onChange={v=>setValue('dhikr',v)}/><PreferenceRow icon="heart-circle-outline" title="Sadaqah Reminders" description="Charity and sadaqah reminders prepared and approved by Family Pledge admins." value={preferences.sadaqah} onChange={v=>setValue('sadaqah',v)}/><PreferenceRow icon="sparkles-outline" title="Motivation" description="Short motivation around consistency, compassion and humanitarian action." value={preferences.motivation} onChange={v=>setValue('motivation',v)} last/></PreferenceSection>
