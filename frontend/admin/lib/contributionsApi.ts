...
function fail(e:unknown):never{if(axios.isAxiosError(e)&&(e.response?.status===401||e.response?.status===403))removeToken();throw new Error(getApiErrorMessage(e,'Could not complete the contribution request.'));}
