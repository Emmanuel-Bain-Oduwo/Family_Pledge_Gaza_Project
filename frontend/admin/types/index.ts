...
export interface TrackedContact { id:string; full_name:string; phone?:string; email?:string; country?:string; status:'following_up'|'pledged'|'paid'|'paused'; notes?:string; is_active:boolean; created_at:string; }
